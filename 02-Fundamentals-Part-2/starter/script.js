...
const myCountry = {
  ...
  describe: function () {
    return `${this.country} has ${this.population} million ${this.language}-speaking people,${this.neighbours.length} neigbhouring countries and a capital called ${this.capital}`;
  },
  checkIsLand: function () {
    return this.neighbours ? (this.isIland = true) : (this.isIland = false);
  },
};
...
for (let vote = 1; vote <= 50; vote++) {
  console.log(`number ${vote} is currently voting`);
}
